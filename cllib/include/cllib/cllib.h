...
void fill_buffer(queue_t queue, buffer_t buffer, size_t size, void *data, bool blocking_write);
void dump_buffer(queue_t queue, buffer_t buffer, size_t size, void *data, bool blocking_read);
